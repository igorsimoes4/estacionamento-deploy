...
@section('title', 'Painel | Precos Carros')
...
@section('content_header')
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3" style="gap: 12px;">
        <div>
            <h1 class="m-0">Precos de Carros</h1>
            <p class="text-muted m-0">Atualize os valores para cobranca por hora, diaria e mensalidade.</p>
        </div>
        <div class="d-flex flex-wrap" style="gap: 8px;">
            <a href="{{ route('priceCar') }}" class="btn {{ request()->routeIs('priceCar') ? 'btn-theme' : 'btn-outline-primary' }}" style="color: {{ request()->routeIs('priceCar') ? '#fff' : 'inherit' }};">
    ...
    <div class="card theme-card">
        ...
        <div class="card-body">
            <div class="theme-panel mb-4">
                <p>Tabela ativa</p>
                <h4>Configuracao de precos para carros</h4>
            </div>
            <x-price.form :price="$priceCar" :route="$route" />
        </div>
    </div>
@endsection
